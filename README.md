...
| Skill | 它解决的问题 | 产出 |
| ----- | ---------- | ---- |
| `skill-e2e-test` | 技能本身会不会"流程全过、成品垃圾"？ | 协议级 E2E：AI 双角色全流程跑 + 机械扫描 + 成品整体评判 |
| `skill-evolution` | 技能怎么越用越像使用者？ | 从对话学习用户风格 + 优化提案 + 推广钩子（潜力作者引荐） |

创作链跑得越多，E2E 验证它没被改坏，进化让它吸收每一次反馈——**四个技能负责写故事，两个配套负责让技能越写越好**。
